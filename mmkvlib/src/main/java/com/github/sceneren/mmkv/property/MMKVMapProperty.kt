...
package com.github.sceneren.mmkv.property
...
class MMKVMap<V>(
    ...
    internal fun String.addPrefix() = "$propertyName$$$this"
        ...
        get() {
            ...
            return object : MutableSet<MutableMap.MutableEntry<String, V>> by entries {
                ...
                override fun iterator(): MutableIterator<MutableMap.MutableEntry<String, V>> {
                    ...
                    return object :
                        MutableIterator<MutableMap.MutableEntry<String, V>> by iterator {
                            ...
                            return object : MutableMap.MutableEntry<String, V> by entry {
                                override fun setValue(newValue: V): V =
                                    entry.setValue(newValue)
                                        .also { encode(key.addPrefix() to newValue) }
                            }
                        }
                    }
                }
